      ...
      <div className="w-full max-w-md">
        <Card className="shadow-lg">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl font-bold text-green-800">Join Your Community</CardTitle>
            <CardDescription className="text-green-600">
              Connect with neighbors in Stoneclough, Prestolee & Ringley
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSignup} className="space-y-4">
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  id="volunteer"
                  checked={isVolunteer}
                  onCheckedChange={(checked) => setIsVolunteer(checked as boolean)}
                />
                <Label htmlFor="volunteer" className="text-sm">
                  I'm interested in volunteering for community activities
                </Label>
              </div>
